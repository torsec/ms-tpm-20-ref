...
void HierarchyPreInstall_Init(void)
{
    ...
    uint8_t seedData[64] = {
        0xD2, 0x4C, 0x47, 0xE9, 0x5C, 0xEB, 0xA6, 0x6A,
        0x92, 0xEA, 0xD1, 0x89, 0x77, 0xC7, 0x1D, 0xE5,
        0xB9, 0x3E, 0x3E, 0xBA, 0x80, 0xC3, 0x84, 0xE2,
        0x73, 0x8E, 0x30, 0x6E, 0x1C, 0xB4, 0xE3, 0xB8,
        0x0E, 0xAD, 0x29, 0x4D, 0xD9, 0x78, 0x64, 0x72,
        0x9D, 0x85, 0x1C, 0x07, 0x05, 0x30, 0x51, 0x33,
        0x2F, 0xC2, 0xFE, 0xDF, 0xD5, 0x1F, 0xC1, 0xC5,
        0xAE, 0xFC, 0xF6, 0xEE, 0x92, 0xAF, 0xF5, 0x47
        };
        memcpy(gp.EPSeed.t.buffer, seedData, gp.EPSeed.t.size);
        printf("Dimensione EPSeed: %d\n", gp.EPSeed.t.size);
        printf("EPSeed: ");
        for(size_t i=0; i < gp.EPSeed.t.size; i++)
        	printf("%02x", gp.EPSeed.t.buffer[i]);
        printf("\n");
#endif
